  ...
  theme: {
    extend: {
      colors: {
        ...
        "on-secondary": "#412d00",
        "on-tertiary": "#422c00",
        "on-tertiary-container": "#684d1a",
        outline: "#99907d",
        "tertiary-fixed-dim": "#e7c183",
        ...
        "primary-container": "#e5c158",
        "on-background": "#e5e2e1",
        "surface-dim": "#131313",
        "on-tertiary-fixed-variant": "#5c4210",
        "secondary-fixed": "#ffdea5",
        "inverse-surface": "#e5e2e1",
        "tertiary-container": "#e5bf81",
      ...
      fontSize: {
        ...
        "headline-xl-mobile": ["38px", { lineHeight: "44px", letterSpacing: "-0.01em", fontWeight: "700" }],
        "headline-sm": ["22px", { lineHeight: "28px", fontWeight: "500" }],
        "label-sm": ["11px", { lineHeight: "14px", letterSpacing: "0.08em", fontWeight: "600" }],
        "label-md": ["13px", { lineHeight: "16px", letterSpacing: "0.06em", fontWeight: "600" }],
